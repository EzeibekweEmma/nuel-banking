      ...
      {open && (
        ...
        >
          <div className="flex shrink-0 items-center gap-3 border-b border-white/10 px-4 py-4">
            ...
            <button type="button" aria-label="Close Nuel assistant" onClick={() => setOpen(false)} className="grid h-9 w-9 shrink-0 place-items-center rounded-xl text-[#b9d0ca] transition hover:bg-white/10 hover:text-white">
          ...
          <form onSubmit={submit} className="m-3 mt-0 flex shrink-0 items-center gap-2 rounded-2xl bg-white p-1.5 pl-3">
            <input name="message" maxLength={2000} required placeholder="Ask Nuel anything…" className="chat-input min-w-0 flex-1 border-0 bg-transparent text-xs text-[#18352e] outline-none shadow-none placeholder:text-[#95a29e]" />
