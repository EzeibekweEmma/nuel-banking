...
export function ChatbotPanel() {
  ...
  return (
    <section className="flex min-h-[370px] flex-col overflow-hidden rounded-[24px] bg-[#102f27] text-white shadow-[0_18px_45px_-32px_rgba(9,45,36,.8)]">
      ...
      <form onSubmit={submit} className="m-3 mt-0 flex items-center gap-2 rounded-2xl bg-white p-1.5 pl-3">
        <input name="message" maxLength={2000} required placeholder="Ask Astra anything…" className="min-w-0 flex-1 border-0 bg-transparent text-xs text-[#18352e] outline-none placeholder:text-[#95a29e]" />
